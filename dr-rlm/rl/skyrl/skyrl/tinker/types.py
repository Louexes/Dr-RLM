...
# pydantic requires typing_extensions.TypedDict on Python < 3.12 (raises PydanticUserError
# on typing.TypedDict); typing_extensions is the documented, version-agnostic import.
