...
class SFTConfig(BaseConfig):
    ...
    """For multimodal checkpoints (e.g. Qwen3.5, which carries a vision_config), load ONLY the
    text backbone (Qwen3_5ForCausalLM) and skip the vision encoder. MUST match the RL policy's
    ``trainer.policy.language_model_only`` for a consistent, text-only SFT->RL handoff."""
